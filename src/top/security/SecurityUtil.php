...
class SecurityUtil
{
    ...
    public function checkEncryptData($dataArray)
    {
        ...
        * 加密逻辑
        */
        public function encrypt($data, $type, $secretContext)
        {
            if (!is_string($data)) {
                return false;
            }
        ...
        */
        public function encryptPhone($data, $separator, $secretContext)
        {
            ...
            return $separator.$prefixNumber.$separator.MagicCrypt::encrypt($last8Number, $secretContext->secret)
        ...
        */
        ...
        {
            return $separator.MagicCrypt::encrypt($data, $secretContext->secret).$separator.$secretContext->secretVersion.$separator;
        }
        ...
        */
        public function decrypt($data, $type, $secretContext)
        {
            ...
            $result = MagicCrypt::decrypt($secretData->originalBase64Value, $secretContext->secret);
